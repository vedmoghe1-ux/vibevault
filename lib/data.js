...
export const AESTHETICS = [
  ...
  { id: "indo-western", name: "Indo Western", tagline: "Where a kurta meets a blazer and neither apologizes", a1: "#E8A33D", a2: "#8B3A62", tone: "#1A1410", note: "kurta · bandhgala · draped", promise: "for festival main character energy" },
  { id: "desi-aesthetic", name: "Desi Aesthetic", tagline: "Everyday India, dressed with intention", a1: "#D9663B", a2: "#4C7A6B", tone: "#171310", note: "cotton · block print · juttis", promise: "for rooted confidence" },
  { id: "new-money", name: "New Money", tagline: "Logos loud, bags heavier, subtlety optional", a1: "#F2C230", a2: "#1F6FEB", tone: "#141014", note: "monogram · leather · chrome", promise: "for main character flex" },
...
export const OUTFITS = [
  ...
  { id: "o24", aesthetic: "old-money", title: "Upper East Side", curator: "@you", saves: 0, promoted: false, real: true,
    ...
    items: [
      ...
      mkReal("i99", "Bottoms", "Men Cotton Comfort Beach Lounge Pants", "The Veshti Company", 963, "#C9B89A", "Stealth wealth", "https://myntr.it/x5XAkOc", "/products/upper-east-side-pants.jpg"),
  ...
  { id: "o25", aesthetic: "streetwear", title: "Acobi After Hours", curator: "@you", saves: 0, promoted: false, real: true,
    ...
    items: [
      mkReal("i101", "Top", "F.R.I.E.N.D.S Men Printed Round Neck Pure Cotton Black T-Shirt", "Souled Store", 1048, "#141414", null, "https://fktr.in/TgCvNxQ", "/products/streetwear-shirt.jpg"),
      mkReal("i102", "Bottoms", "Men Loose Fit Black Cotton Blend Trousers", "Trackflip", 340, "#161616", null, "https://fktr.in/EfyediW", "/products/streetwear-bottoms.jpg"),
      mkReal("i103", "Shoes", "Revolution 7 Men's Road Running Shoes", "Nike", 3326, "#2A2D31", null, "https://myntr.it/nRDQRHN", "/products/streetwear-shoes.jpg"),
    ] },
];
