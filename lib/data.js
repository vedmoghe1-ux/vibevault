export const AESTHETICS = [
  ...
  { id: "coquette", name: "Coquette", tagline: "Bows, lace, and a little too much innocence", a1: "#FFC9DE", a2: "#E8A0B4", tone: "#1C1417", note: "satin · lace · pearls" },
  { id: "mob-wife", name: "Mob Wife", tagline: "Fur, gold, and zero apologies", a1: "#C99A5B", a2: "#7A2E2E", tone: "#1A1210", note: "fur · leopard · gold chain" },
  { id: "indie-sleaze", name: "Indie Sleaze", tagline: "Flash photography, smudged liner, 3am energy", a1: "#E8E252", a2: "#FF5C8A", tone: "#141018", note: "denim · leather · glitter" },
  { id: "balletcore", name: "Balletcore", tagline: "Wrap tops, soft pink, quiet discipline", a1: "#F6D6E0", a2: "#C9B8D8", tone: "#17141A", note: "tulle · ribbon · knit" },
];
